    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16 mb-24">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-4">
          ...
          {[
            ...
            <Link key={link.label} href={link.path} className={`${outfit.className} text-sm text-white/70 md:hover:text-white active:text-white transition-all duration-300 flex items-center gap-2.5 group w-max`}>
              <motion.svg whileHover={{ x: 5 }} className="w-3.5 h-3.5 text-white/40 md:group-hover:text-white group-active:text-white transition-colors stroke-[2.5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </motion.svg>
              <span className="md:group-hover:translate-x-1 group-active:translate-x-1 transition-transform duration-300 block">{link.label}</span>
            </Link>
          ))}
        </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        ...
        <div className="flex items-center gap-2">
          <MagneticWrapper>
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-white/50 md:hover:text-white active:text-white transition-colors" aria-label="Facebook">
          ...
          <MagneticWrapper>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-white/50 md:hover:text-white active:text-white transition-colors" aria-label="Instagram">
              <svg className="w-5 h-5 fill-current pointer-events-none" viewBox="0 0 24 24">
          ...
          <MagneticWrapper>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-white/50 md:hover:text-white active:text-white transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5 fill-current pointer-events-none" viewBox="0 0 24 24">
